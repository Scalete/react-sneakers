  ...
  const renderCurrentDeleteBtnState = (isDeleteProductCartLoading) => {
    const loading = (
      <img
        ...
        alt="Loading"
        style={{
          display: isDeleteProductCartLoading ? 'block' : 'none',
          width: '25px',
          height: '25px',
        }}
      />
    ...
    const addImg = (
      <svg
        ...
        <rect x=".5" y=".5" width="31" height="31" rx="7.5" fill="#fff" stroke="#DBDBDB" />
        <path
  ...
  return (
    <div className="product">
      ...
      <div
        ...
        onClick={() => onDeleteCartProduct(id, cartItemId, setIsDeleteProductCartLoading)}>
