          ...
          <li className="header-item">
            <Link to="/orders">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M15 2.717v-.7A6.804 6.804 0 0 0 10.516.018a2.844 2.844 0 0 0-2.513.995A3.02 3.02 0 0 0 5.488.018 6.804 6.804 0 0 0 1 2.017v.7l-1 .3v10l6.7-1.4.3.4h2l.3-.4 6.7 1.4v-10l-1-.3Zm-9.52 6.61a8.206 8.206 0 0 0-3.526.902L2 2.437a5.22 5.22 0 0 1 3.369-1.42 4.553 4.553 0 0 1 2.159.701l-.019 7.869a6.548 6.548 0 0 0-2.039-.259l.01-.001Zm8.52.88a8.122 8.122 0 0 0-3.468-.88l-.161-.002c-.66 0-1.297.096-1.899.274l.047-7.902a4.484 4.484 0 0 1 2.096-.679 5.216 5.216 0 0 1 3.386 1.422l-.003 7.768.002-.001Z"
                  fill="#1C2E45"
                  fillOpacity=".6"
                />
              </svg>
